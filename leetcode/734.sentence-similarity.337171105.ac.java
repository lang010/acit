 ...
 * similarity relation is not transitive. For example, if the words a and b are
 * similar and the words b and c are similar, a and c are not necessarily
 * similar.
 * 
 * 
 * Example 1:
...
class Solution {
    public boolean areSentencesSimilar(String[] words1, String[] words2, List<List<String>> pairs) {
        ...
        for (List<String> ls : pairs) {
            put(map, ls.get(0), ls.get(1));
            put(map, ls.get(1), ls.get(0));
        }
    ...
    void put(Map<String, Set<String>> map, String s1, String s2) {
